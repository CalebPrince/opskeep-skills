...
- `skills/opskeep-define-work/references/initiate-stakeholder-map.md`: role, influence, decision authority.
- `skills/opskeep-deliver-work/references/monitor-status.md`: anchor updates in delivery reality.
- `skills/opskeep-deliver-work/references/monitor-risk-escalation.md`: trust/owner drift/blocker escalation.
- `skills/opskeep-improve-operations/references/close-handover-transition.md`: transition ownership.

## Connected Capabilities

- `opskeep-follow-up-reminders`: only future self-email reminder.
- `composio`: only live email/CRM/calendar access or explicit external send.
- `opskeep-manage`/`opskeep-triggers`: only automate future client-health checks.
