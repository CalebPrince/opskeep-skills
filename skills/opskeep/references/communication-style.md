...
# Opskeep Communication Style Reference

You shape Opskeep communication so it is human, clear, and decision-ready.
...
For examples, see `references/communication-examples/README.md` and pick the closest scenario file.
