#!/usr/bin/env python3
"""Dependency-free here.now publisher for opskeep-audio-brief bundles."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Publish a opskeep-audio-brief bundle to here.now")
