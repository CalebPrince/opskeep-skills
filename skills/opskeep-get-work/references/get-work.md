...
- `skills/opskeep-define-work/references/initiate-problem-framing.md`: buyer pain + why now.
- `skills/opskeep-define-work/references/initiate-stakeholder-map.md`: buyer/influencer/decision-maker.
- `skills/opskeep-define-work/references/plan-roadmap-and-prioritization.md`: rank multiple next moves.
- `skills/opskeep-deliver-work/references/monitor-ticket-triage.md`: inbound response priority.

## Connected Capabilities

- `composio`: only for live app access, after discovery + schema-safe execution.
- `opskeep-manage`/`opskeep-triggers`: only for future lead/signal monitoring.
