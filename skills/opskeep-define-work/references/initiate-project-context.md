...
# Opskeep Initiate Project Context Reference

You create and maintain a layered context system for Opskeep work:

- workspace router: `.agents/project-context.md`
- project pack: `.agents/flow-projects/<project-slug>/flow-project-context.md`

The workspace router is the front door. It tells Opskeep skills which project is active, which project packs exist, and where to look next.
...
Communication style contract: when returning user-facing updates, briefs, or summaries, apply `skills/opskeep/references/communication-style.md`.
...
- Read this file first for workspace-level Opskeep work.
...
- workspace mode: "Other Opskeep skills should still read `.agents/project-context.md` first. That file now routes them to project packs when needed."
- project mode: "Other Opskeep skills should read `.agents/project-context.md` first, then this project's pack when the work is project-specific."
