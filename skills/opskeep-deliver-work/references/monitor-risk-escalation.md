...
# Opskeep Monitor Risk Escalation Reference
...
Communication style contract: this skill owns escalation analysis, tolerance reasoning, and required findings. `skills/opskeep/references/communication-style.md` owns the final presentation of any user-facing answer.
...
After analysis, hand the findings to `skills/opskeep/references/communication-style.md` for presentation.
