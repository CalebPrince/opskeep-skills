...
3. **Change control mode**
   ...
   - Load `skills/opskeep-get-paid/references/execute-change-control.md` when the change has money, scope, or budget impact.
...
- load the selected Opskeep reference when a focused reference matches
